...
function AddExpenseModal({isExpenseModalVisible, handleExpenseCancel, onFinish}) {
  ...
  return (
    <>
    <Modal style={{fontWeight:900}} title="Add Expense" visible={isExpenseModalVisible} onCancel={handleExpenseCancel} footer={null}>
      ...
      <Form form={form} layout='vertical' onFinish={(values)=>{onFinish(values,"expense"); form.resetFields();}}>
            ...
            <Form.Item style={{fontWeight:500}} label="Amount" name="amount" 
                rules={[{ required:true, message:"Please write the expense amount!"}]}>
